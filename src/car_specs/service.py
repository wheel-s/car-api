...
def create_spec(db:Session, spec_create:model.createSpec, current_user:TokenData)->model.specResponse:
    try:
...
def update_spec(db:Session, spec_id:UUID, spec_update:model.createSpec, current_user:TokenData)->model.specResponse:

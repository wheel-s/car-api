...
SECRET_KEY = "fkpaekpeafvmefdsdfnsdfkq3r3"
ALGORITHM = "HS256"
...
def register_user(db: Session, register_user_request: models.RegisterUser) -> None:
    try:
...
def get_current_user(token: Annotated[str, Depends(oauth2_bearer)]) -> models.Token:
